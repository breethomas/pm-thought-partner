...
**Works with:**
- **Linear** - Analyzes product/feature issues for loop potential
- **Manual** - Maps your product to loop opportunities
- **GitHub Issues** - Reviews features for growth mechanics
